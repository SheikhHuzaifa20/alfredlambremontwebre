...
<div class="featured">
    <div class="wrap">
        <div class="cover" style="max-width:500px">
            <img src="images/alfred-webew.webp" class="img-fluid" alt="">
            <img src="images/awake-now.webp" class="img-fluid" alt="">
        </div>
        <div>
...
<div class="about" id="about">
    <div class="wrap">
        <div>
            <img src="images/author-img.png" class="img-fluid" alt="">
        </div>
        <div>
