...
<body>
    ...
    @php
        ...
        $customerName = !empty($customerName) ? $customerName : 'Guest Customer';

        $customerEmail = $order->order_email ?? 'N/A';
        $customerPhone = $order->delivery_phone_no ?? 'N/A';
    ...
    @php
        ...
        $shippingFee = $order->order_shipping ?? ($order->shipping_tax ?? 0.0);
