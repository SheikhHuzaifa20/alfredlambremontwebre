                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" required="required" name="catalogue"
                                                        type="text" id="catalogue">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="catalogue_link">Catalogue Button link</label>
                                                    <input class="form-control" required="required" name="catalogue_link"
                                                        type="text" id="catalogue_link">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="about">About Button</label>
                                                    <input class="form-control" required="required" name="about"
                                                        type="text" id="about">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" required="required" name="about_link"
                                                        type="text" id="about_link">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="summary-ckeditor2">Short Description</label>
                                                    <textarea name="text_2" id="summary-ckeditor2" cols="30" rows="10" class="form-control" required></textarea>
                                                </div>
                                            </div>
                                            {{-- <div class="col-md-12">
                                            <div class="form-group">
