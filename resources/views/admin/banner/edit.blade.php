                          ...
                          <form class="form" enctype="multipart/form-data" method="post" action="{{route('admin.banner.update', $banner->id)}}">
                              ...
                              <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="catalogue">Catalogue Button</label>
                                                <input class="form-control" required="required" name="catalogue" type="text" id="catalogue" value="{{$banner->catalogue}}">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="catalogue_link">Catalogue Button link</label>
                                                <input class="form-control" required="required" name="catalogue_link" type="text" id="catalogue_link" value="{{$banner->catalogue_link}}">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="about">About Button</label>
                                                <input class="form-control" required="required" name="about" type="text" id="about" value="{{$banner->about}}">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="about_link">About Button link</label>
                                                <input class="form-control" required="required" name="about_link" type="text" id="about_link" value="{{$banner->about_link}}">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="summary-ckeditor2">Short Description</label>
                                                <textarea name="text_2" id="summary-ckeditor2" cols="30" rows="10" class="form-control" required>{{$banner->text_2}}</textarea>
                                            </div>
                                        </div>
                                        {{-- <div class="col-md-12">
                                            <div class="form-group">
